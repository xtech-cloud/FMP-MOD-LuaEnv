...
local function buildSlider(_target, _direction, _size)
    ...
    if _direction == ugui.Slider.Direction.BottomToTop then
        ...
        resetRectTransform(objHandleSlideArea, unity.Vector2(0, 0), unity.Vector2(1, 1), unity.Vector2(0, 0), unity.Vector2(0, -36), unity.Vector2(0.5,0.5))
    else
        ...
        resetRectTransform(objHandleSlideArea, unity.Vector2(0, 0), unity.Vector2(1, 1), unity.Vector2(0, 0), unity.Vector2(-36, 0), unity.Vector2(0.5,0.5))
    end
    ...
    if _direction == ugui.Slider.Direction.BottomToTop then
        ...
        resetRectTransform(objHandle, unity.Vector2(0, 0), unity.Vector2(1, 0), unity.Vector2(0, 0), unity.Vector2(28, 36), unity.Vector2(0.5,0.5))
    else
